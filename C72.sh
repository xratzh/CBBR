...
# wget http://mirror.rc.usf.edu/compute_lock/elrepo/kernel/el7/x86_64/RPMS/kernel-ml-headers-4.11.8-1.el7.elrepo.x86_64.rpm
wget https://raw.githubusercontent.com/xratzh/CBBR/master/kernel7/kernel-ml-headers-4.11.8-1.el7.elrepo.x86_64.rpm
rpm -Uvh kernel-ml-headers-4.11.8-1.el7.elrepo.x86_64.rpm
...
wget https://raw.githubusercontent.com/xratzh/CBBR/master/kernel7/kernel-ml-devel-4.11.8-1.el7.elrepo.x86_64.rpm
rpm -Uvh kernel-ml-devel-4.11.8-1.el7.elrepo.x86_64.rpm
